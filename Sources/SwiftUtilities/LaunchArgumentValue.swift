...
///
/// Define your launch arguments as a `String`-backed enum conforming to `LaunchArgument`,
...
/// }
/// ```
public class LaunchArgumentsController<T: LaunchArgument>: @unchecked Sendable {
